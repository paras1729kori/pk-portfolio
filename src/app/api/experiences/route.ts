  ...
  const data: ExperienceDataType[] = [
    {
      ...
      description:
        "Developing and managing frontend (web based) projects of Healiom Inc., an AI-based real time specialist care logistics platform that enables access to real-time medical specialists. Working with various types of technologies including Websockets, Caddy Servers and other exciting tech.",
      tech_stack: [
        "React",
        "Redux.js",
        "Redux Thunk",
